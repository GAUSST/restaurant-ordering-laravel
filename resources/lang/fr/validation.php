...
return [
    ...
    */
    ...
    'accepted_if' => 'L\' :attribute doit être accepté lorsque :other vaut :value.',
    ...
    'email' => 'Entrez une addresse e-mail valide.',
    ...
    'max' => [
        ...
        'file' => 'Ce image ne doit pas être supérieur à :max kilo-octets.',
        'string' => 'Le contenue ne doit pas être supérieur à :max caractères.',
    ...
    'min' => [
        ...
        'file' => 'Ce champs doit faire au moins :min kilo-octets.',
